        ...
        <nav class="navbar navbar-expand-lg bg-dark  navbar-dark">
            <div class="container-fluid m-2">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    class="boton_nav-login bg-success ">INGRESAR</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav">
                        <a href="/login/view/home/logout.php" 
                        class="boton_nav-login bg-danger ">SALIR</a>
                    </ul>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            href="/login/view/home/editProfile.php">EDITAR PERFIL</a>
                        </li>
                    </ul>
