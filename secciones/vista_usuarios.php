                            ...
                            <div class="text-center row m-3">
                                <div class="col-6">
                                    <button class="btn bg-success text-light mt-2 ">
                                        <a class="nav-link text-center boton_nav-estad" href="/login/secciones/vista_usuarios-add.php">
                                ...
                                <div class="col-6">
                                    <form action="vista_usuarios.php" method="post">
                                        ...
                                        <input type="submit" value="Buscar Usuario" class="btn btn-primary boton_nav-estad">
                                    </form>
                                </div>
                            </div>
                                                        ...
                                                        <div class="d-flex ">
                                                            <form action="/login/secciones/vista_usuarios-edit.php" method="post">
                                                                <div role="group" aria-label="Button group name">
                                                                    ...
                                                                    value="editar" class="btn btn-warning m-1 boton_nav-estad">EDITAR
                                                                    </button>
                                                                </div>
                                                            </form>
                                                            ...
                                                            <form action="/login/secciones/vista_usuarios.php" method="post">
                                                                <div role="group" aria-label="Button group name">
                                                                    ...
                                                                    value="borrar" class="btn btn-danger m-1 boton_nav-estad">QUITAR
                                                                    </button>
                                                                </div>
                                                            </form>
                                                        </div>
