                            ...
                            <div class="card card-background p-1">
                                ...
                                <div class="p-3">
                                    ...
                                    <div class="card-body row">
                                        ...
                                        <div class="mb-3 col-3">
                                            <label for="ECALLE_1" class="form-label text-secondary">Entre</label>
                                            <input type="text" class="form-control bg-primary-subtle text-primary-emphasis" 
                                                name="ECALLE_1" id="ECALLE_1" value="<?php echo $ECALLE_1; ?>" placeholder="Entre Calle 1">
                                        </div>
                                        <div class="mb-3 col-3">
                                            <label for="ECALLE_2" class="form-label text-secondary">Entre:</label>
                                            <input type="text" class="form-control bg-primary-subtle text-primary-emphasis" 
                                        ...
                                        <div class="mb-3 col-2">
                                            <label for="CPOSTAL" class="form-label text-secondary">CP.:</label>
                                            <input type="text" class="form-control bg-primary-subtle text-primary-emphasis" 
                                        ...
                                        <div class="mb-3 col-3">
                                            <label for="NAFILIADO" class="form-label text-secondary">Afiliado:</label>
                                            <input type="text" class="form-control bg-primary-subtle text-primary-emphasis" 
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select multiple class="form-control" name="actividades[]" id="arrayActividadesSocios">
                                                        <option class="text-primary fw-bold" value="">Seleccione actividades para vincular:</option>
                                                ...
                                                <!-- <div role="group" aria-label="Button group name">
                                                        <button type="submit" name="accion" value="agregarAct" 
                                                            class="btn btn-primary">Agregar Actividad
                                                        </button>
                                                    </div> -->
                                                <div class="mt-3">
                                                    <div class="container px-2 py-2 mt-2">
                                                        ...
                                                        <small class="text-danger">Puede remover las actividades que ya no desea vincular</small>
                                                    </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <select multiple class="form-control" name="comisiones[]" id="arrayComisionesSocios">
                                                        <option class="text-success fw-bold" value="">Seleccione Comisiones a vincular:</option>
                                                ...
                                                <!-- <div role="group" aria-label="Button group name">
                                                        <button type="submit" name="accion" value="agregarAct" 
                                                            class="btn btn-success">Agregar Comision
                                                        </button>
                                                    </div> -->
                                                <div class="mt-3">
                                                    <div class="container px-2 py-2 mt-2">
                                                        ...
                                                        <small class="text-danger">Puede remover las comisiones que ya no desea vincular</small>
                                                    </div>
                                        ...
                                        <div class="container row mt-3">
                                            ...
                                            <div class="col-4 bg-warning text-warning text-center card fw-bold">
                                                ...
                                                <button onclick="return confirmEdit();" type="submit" name="accion" value="editar" class="btn btn-warning boton_nav-estad">EDITAR SOCIO
                                                </button>
                                            </div>
                                        </div>
                                    </div>
