...
if($accion!="") {
    switch($accion){
       case "agregar":
          $sql="INSERT INTO actividades (id, nombre_actividad, lugar) VALUES (null, :nombre_actividad, :lugar)";
       ...
       case "editar":
          $sql="UPDATE actividades SET nombre_actividad=:nombre_actividad, lugar=:lugar WHERE id=:id";
          $query=$conexionDB->prepare($sql);
