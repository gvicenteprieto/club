        ...
        <div class="row">
            ...
            <div class="container text-center mt-3">
                <div class="row justify-content-between">
                    <div class="col-4">
                        <form action="/login/secciones/vista_usuarios-edit.php" method="post">
                            <div role="group" aria-label="Button group name">
                                ...
                                <button onclick="return confirmEdit();" type="submit" name="accion" value="editar" class="boton_nav-secc btn btn-warning m-2">
                    ...
                    <div class="col-4">
                        <div>
                            <a href="./vista_usuarios.php" class="boton_nav-estad btn btn-secondary m-2">
                                REGRESAR
                            </a>
                        </div>
                    </div>
